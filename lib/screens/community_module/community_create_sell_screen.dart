...
class CommunityCreateSellScreen extends StatefulWidget {
  final int id;

  const CommunityCreateSellScreen({super.key, required this.id});

  @override
  _CommunityCreateSellScreenState createState() =>
      _CommunityCreateSellScreenState();
}

class _CommunityCreateSellScreenState extends State<CommunityCreateSellScreen> {
